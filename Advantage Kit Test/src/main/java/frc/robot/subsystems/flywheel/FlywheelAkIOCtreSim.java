...
public class FlywheelAkIOCtreSim implements FlywheelAkIO {
  private static final double GEAR_RATIO = 1.5;

  private final TalonFX leader = new TalonFX(0);
  private final TalonFXSimState lead = leader.getSimState();
  ...
  public void setVoltage(double volts) {
    lead.setSupplyVoltage(volts);
  }

  @Override
  public void setVelocity(double velocityRadPerSec, double ffVolts) {
    lead.setRotorVelocity(velocityRadPerSec);
  }

  @Override
  public void stop() {
    lead.setSupplyVoltage(0);
  }
