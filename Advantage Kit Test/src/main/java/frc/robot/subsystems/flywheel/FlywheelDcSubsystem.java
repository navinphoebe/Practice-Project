...
public class FlywheelDcSubsystem extends SubsystemBase implements FlywheelSubystem {

  public IRavenMotor m_motor;
  /** Creates a new FlywheelDcSubsystem. */
  public FlywheelDcSubsystem() {
      m_motor = new RavenDCMotorSim();
